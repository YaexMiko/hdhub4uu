...
async def batch(client: Client, message: Message):
    ...
    await second_message.reply_text(f"<b>🧑‍💻 𝙷𝚎𝚛𝚎 𝙸𝚜 𝚈𝚘𝚞𝚛 𝙲𝚘𝚍𝚎 : \n\n<code>{base64_string}</code></b>\n\n<b>🔗 📤𝙷𝚎𝚛𝚎 𝙸𝚜 𝚈𝚘𝚞𝚛 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙻𝚒𝚗𝚔📥 :</b>\n{link}", quote=True, reply_markup=reply_markup)
...
async def link_generator(client: Client, message: Message):
    while True:
        ...
        if msg_id:
            ...
            await channel_message.reply("❌ 𝙴𝚛𝚛𝚘𝚛\n\n𝚃𝚑𝚒𝚜 𝙵𝚘𝚛𝚠𝚊𝚛𝚍𝚎𝚍 𝙿𝚘𝚜𝚝 𝙸𝚜 𝙽𝚘𝚝 𝙵𝚛𝚘𝚖 𝙼𝚢 𝙳𝚋 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 𝙾𝚛 𝚃𝚑𝚒𝚜 𝙻𝚒𝚗𝚔 𝙸𝚜 𝙽𝚘𝚝 𝚃𝚊𝚔𝚎𝚗 𝙵𝚛𝚘𝚖 𝙳𝙱 𝙲𝚑𝚊𝚗𝚗𝚎𝚕", quote = True)
            continue
    ...
    await channel_message.reply_text(f"<b>🧑‍💻 𝙷𝚎𝚛𝚎 𝙸𝚜 𝚈𝚘𝚞𝚛 𝙲𝚘𝚍𝚎 : \n\n<code>{base64_string}</code></b>\n\n<b>🔗 📤𝙷𝚎𝚛𝚎 𝙸𝚜 𝚈𝚘𝚞𝚛 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙻𝚒𝚗𝚔📥 : </b>\n{link}", quote=True, reply_markup=reply_markup)
