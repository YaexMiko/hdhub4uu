...
async def start_command(client: Client, message: Message):
    ...
    if USE_SHORTLINK and (not U_S_E_P): 
        ...
        if not verify_status['is_verified']:
            ...
            await message.reply(f"𝚈𝚘𝚞𝚛 𝙰𝚍𝚜 𝚃𝚘𝚔𝚎𝚗 𝙸𝚜 𝙴𝚡𝚙𝚒𝚛𝚎𝚍, 𝚁𝚎𝚏𝚛𝚎𝚜𝚑 𝚈𝚘𝚞𝚛 𝚃𝚘𝚔𝚎𝚗 𝙰𝚗𝚍 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗. \n\n𝚃𝚘𝚔𝚎𝚗 𝚃𝚒𝚖𝚎𝚘𝚞𝚝: {get_exp_time(VERIFY_EXPIRE)}\n\n𝚆𝚑𝚊𝚝 𝙸𝚜 𝚃𝚑𝚎 𝚃𝚘𝚔𝚎𝚗?\n\n𝚃𝚑𝚒𝚜 𝙸𝚜 𝙰𝚗 𝙰𝚍𝚜 𝚃𝚘𝚔𝚎𝚗. 𝙸𝚏 𝚈𝚘𝚞 𝙿𝚊𝚜𝚜 3 𝙿𝚊𝚐𝚎 𝙰𝚍, 𝚈𝚘𝚞 𝙲𝚊𝚗 𝚄𝚜𝚎 𝚃𝚑𝚎 𝙱𝚘𝚝 𝙵𝚘𝚛 {get_exp_time(VERIFY_EXPIRE)} 𝙰𝚏𝚝𝚎𝚛 𝙿𝚊𝚜𝚜𝚒𝚗𝚐 𝚃𝚑𝚎 𝙰𝚍.", reply_markup=InlineKeyboardMarkup(btn), protect_content=False, quote=True)
            return
    return
