...
#UPI ID
UPI_ID = os.environ.get("UPI_ID", "First Contact Owner To Take Upi Id @Alya_x_Yuki")
#UPI QR CODE IMAGE
...
#3 Month
PRICE3 = os.environ.get("PRICE3", "320 rs")
#6 Month
...
#custom caption 
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @Alya_x_Yuki</b>")
